...
<header class="navbar">
      ...
      <a href="userDashboard.php" class="nav-item">Dashboard</a>
        <a href="userEvents.php" class="nav-item">Events</a>
        <a href="userClubs.php" class="nav-item">Clubs</a>
      </nav>
      <div class="nav-right">
        ...
        <?php while ($row = mysqli_fetch_assoc($query)): ?>
            <div class="club-card">
                ...
                <div class="club-content">
                    ...
                    <!-- Join Button -->
                    <a href="joinClub.php?id=<?= urlencode($row["id"]) ?>" class="join-button">Join Club</a>
                </div>
            </div>
        <?php endwhile; ?>
    </section>
